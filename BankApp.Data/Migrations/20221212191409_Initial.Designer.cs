...
namespace BankApp.Data.Migrations
{
    ...
    [Migration("20221212191409_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankApp.Core.Domain.Entities.Account", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Core.Domain.Entities.Balance", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Core.Domain.Entities.BankTransaction", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Core.Domain.Entities.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BankApp.Core.Domain.Entities.Mileage", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Core.Domain.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("BankApp.Core.Domain.Entities.Vehicle", b =>
                {
                    b.Property<int>("VehicleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BankApp.Core.Domain.Entities.Balance", b =>
                {
                    b.HasOne("BankApp.Core.Domain.Entities.Account", "Account")
                        .WithMany("Balances")
            ...
            modelBuilder.Entity("BankApp.Core.Domain.Entities.BankTransaction", b =>
                {
                    ...
                    b.HasOne("BankApp.Core.Domain.Entities.Category", "Category")
                        .WithMany("BankTransactions")
            ...
            modelBuilder.Entity("BankApp.Core.Domain.Entities.Mileage", b =>
                {
                    b.HasOne("BankApp.Core.Domain.Entities.Vehicle", "Vehicle")
                        .WithMany("Mileages")
